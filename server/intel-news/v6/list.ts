 ...
 * only by RSS presence (`isCategoryCorroborated` — no multi-source floor;
 * product wants the category feeds dense). Optional `?category=X`
 * pre-filters to one category server-side.
 *
